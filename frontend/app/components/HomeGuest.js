    ...
    switch (action.type) {
      case "usernameImmediately":
        ...
        if (draft.username.value.length > 30) {
          ...
          draft.username.message = "Username cannot exceed to 30 characters";
        }
        if (
      ...
      case "passwordImmediately":
        ...
        if (draft.password.value.length > 50) {
          ...
          draft.password.message = "Password cannot exceed to 50 characters";
        }
        return;
    ...
    if (state.submitCount) {
      ...
      async function fetchResults() {
        try {
          ...
          appDispatch({
            type: "flashMessage",
            value: "Congratulations! You've successfully signed up"
          });
        } catch (err) {
          console.log("There was a problem or request was cancelled.");
        }
